...
const DownloadReport = () => {
  ...
  return (
    <div className="min-h-screen p-4 md:p-6 lg:p-8 bg-gray-50 flex flex-col gap-6">
      {/* --- First Card: OHLC --- */}
      <Card
        className="w-full rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300 bg-white"
      ...
      >
        <Row gutter={[16, 20]} align="bottom">
          ...
          <Col xs={24} sm={12} lg={6}>
            <div className="flex flex-col">
              <Text className={labelClass}>Search Stocks</Text>
              <Input
                size="large"
                placeholder="Search Stocks"
                suffix={<SearchOutlined className="text-gray-400" />}
          ...
          <Col xs={24} sm={12} lg={3}>
            <div className="flex items-center h-full pt-6 lg:pt-0">
              <Checkbox className="text-gray-600 font-medium">
                All Strategy
              </Checkbox>
            </div>
          ...
          <Col xs={24} lg={2}>
            <Button
              size="large"
              disabled
              className="w-full font-medium border-none bg-gray-100 !text-gray-400 rounded-lg mt-6 lg:mt-0"
            >
              Download
            </Button>
          </Col>
        ...
        <Row gutter={[16, 20]} align="bottom">
          ...
          <Col xs={24} lg={4}>
            <Button
              ...
              type="primary"
              icon={<DownloadOutlined />}
              className="w-full font-medium border-none bg-[#4f9c73] hover:!bg-[#3d7d5b] shadow-sm rounded-lg transition-colors mt-6 lg:mt-0"
            >
              Download CSV
            </Button>
          </Col>
